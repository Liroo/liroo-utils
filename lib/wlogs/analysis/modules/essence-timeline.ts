...
import { GET_CAST_EVENTS, GET_BUFF_EVENTS } from "../../client/queries";
import { SPELLS, spellName } from "../../constants/spells";
...
export async function buildEssenceTimeline(
  ...
  const [casts, buffs] = await Promise.all([
    fetchAllPaginated(wcl, GET_CAST_EVENTS, {
      code,
      fightIDs: [fightID],
      startTime,
      endTime,
    ...
    fetchAllPaginated(wcl, GET_BUFF_EVENTS, {
      code,
      fightIDs: [fightID],
      startTime,
      endTime,
